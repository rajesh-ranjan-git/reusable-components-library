  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-bg selection:bg-primary/30 p-4 sm:p-6 w-full h-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <motion.div
                layout
                className="flex justify-center items-center shadow-black/10 shadow-lg rounded-full w-12 md:w-20 h-12 md:h-20 group-hover:scale-105 transition-transform shrink-0"
              >
                <Image
              ...
              <motion.div
                layout
                className="flex flex-col items-start md:items-center gap-0 md:gap-1 mt-0 md:mt-2"
              >
        ...
        <div className="z-10 relative flex flex-col bg-surface w-full md:w-1/2 h-full overflow-hidden shrink-0">
          <AnimatePresence mode="wait">
            {isLogin ? (
              <motion.div
                key="login-form"
